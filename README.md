# CookiesShallNotPass
 **User Manual** → [Click here to read](https://github.com/AryanV08/CookiesShallNotPass/blob/main/docs/USER_MANUAL.md) <br>
 **Developer Manual**  →  [Click here to read](https://github.com/AryanV08/CookiesShallNotPass/blob/main/docs/Developer_MANUAL.md) 
 <br>
